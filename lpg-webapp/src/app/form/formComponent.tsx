...
export default function FormComponent({ data }: any) {
    ...
    const { cpuBenchmark, setCpuBenchmark, gpuBenchmark, setGpuBenchmark, ssdBenchmark, setSsdBenchmark, hddBenchmark, setHddBenchmark, ramBenchmark, setRamBenchmark, category, setCategory } = useBenchmarkContext();

    function submit() {
        console.log(cpuBenchmark, gpuBenchmark, ssdBenchmark, hddBenchmark, ramBenchmark, category)

            ...
            <div className="w-full max-w-4xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-xl rounded-xl p-8 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className={`text-5xl font-extrabold ${totalResult - totalResult2 >= 0 ? "text-green-400" : "text-red-400"}`}>
                            {totalResult - totalResult2 > 0 ? `+${Math.round(totalResult - totalResult2)}` : Math.round(totalResult - totalResult2)}%
                        </p>
                    </div>
                    <div className="text-center">
                    ...
                    <tbody>
                        {[
                            ...
                            return (
                                ...
                                >
                                    <td className="py-4 text-lg font-medium text-gray-700">{item.name}</td>
                                    <td className="py-4 text-lg text-gray-600">{roundedValue1}</td>
                                    <td
                                    ...
                                    <td className="py-4 text-lg text-gray-600">{roundedValue2}</td>
                                </tr>
                            );
                        })}
                    </tbody>
